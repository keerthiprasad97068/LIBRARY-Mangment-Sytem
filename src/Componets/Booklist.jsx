                ...
                {book.map(data => (
                    ...
                    <div className="bookCard">
                        <div className="bookimag">
                            <img height={200} width={290} src={data.thumbnailUrl} alt="" />
                        </div>
                        ...
                        <div className="bookimfbtn">
                            <button id="read" onClick={() => showmore(data.id)} >Read More</button>
                            {
                        location.pathname == '/admin/Booklist' && <button id="delete" onClick={()=>remove(data.id, data.title)}>Delete</button>
                            }
                        </div>
                    </div>
