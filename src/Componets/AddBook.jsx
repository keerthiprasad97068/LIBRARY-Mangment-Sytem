            ...
            <div className="AddForm">
                <form action="" onSubmit={handlesumbit}>
                    <div className="booktitle">
                        <input type="text" placeholder="Title" onChange={(e)=> settitel(e.target.value) } />
                    </div>
                    ...
                    <div className="BookpageCount">
                        <input type="number" placeholder="PageCount" onChange={(e)=>setPagecount(e.target.value)} />
                    </div>
                    <div className="shortdescription">
                        <textarea cols="30" rows="10" placeholder="Short Description" onChange={(e)=>setshortDesc(e.target.value)}></textarea>
                    </div>
                    <div className="longdescription">
                        <textarea name="" id="" cols="30" rows="10" placeholder="LongDescription" onChange={(e)=>SetLongDes(e.target.value)}></textarea>
                    </div>
                    <div className="thumbnailURL">
                        <input type="text" onChange={(e)=>setthumb(e.target.value)} />
                    </div>
